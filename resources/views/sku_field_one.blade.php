<div class="{{$viewClass['form-group']}}">
    ...
    <div class="{{$viewClass['field']}}">
        ...
        <div class="sku_warp {{$class}}">
            <input type="hidden" class="Js_one_sku_input" name="{{$name}}" value="{{old($column, $value)}}">
            <div class="sku_one_attr_select">
...
<!-- 多规格-->
            <div class="sku_one_attr_key_val" style="display: none">
            ...
            <!-- 操作SKU -->
            <div class="sku_one_edit_warp" style="display: none">
